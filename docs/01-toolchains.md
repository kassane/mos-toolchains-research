...
**ImportC** (pass a `.c` straight to `ldc2`) works for MOS — but the C preprocessor must be a
...
```bash
$LDC -betterC -Oz -mtriple=mos -mcpu=mos6502 -mattr=$MOS_MATTR -gcc=$SDKBIN/mos-sim-clang -P-I<dir> -c file.c -of=o.o
```
